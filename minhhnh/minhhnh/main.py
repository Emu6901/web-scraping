...
class Utilily:
    ...
    def try_except_find_element(
        container, by, value, default_return="", get_text=False
    ):
        try:
...
class Find:
    ...
    def find_comment_ids(driver):
        comments = driver.find_elements(by=By.CLASS_NAME, value="review")
...
class GetInformation:
    ...
    def extract_comment(comment_container, comment_id):
        ...
        print(author, reviewDate, reviewText, staticStar, likesCount, sep="\n")
...
def crawl():
    ...
    while True:
        ...
        while book_index < len(books):
            ...
            comment_ids = CFG.wait.until(Find.find_comment_ids)
            comment_index = 0
            while comment_index < len(comment_ids):
                ...
                reply_index = 0
                while reply_index < len(reply_ids):
